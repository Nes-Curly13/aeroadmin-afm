...
//
// Decision de producto (handoff 2026-09-20, §3):
//   Una fumigacion = parcela + dia + sesion. Si el hueco (idle gap) entre
//   un vuelo y el siguiente supera 1 hora, es una fumigacion DISTINTA
//   (separa manana/tarde). Los vuelos sin parcela (huerfanos) se agrupan
//   igual, pero con `parcelId = null` y `orphan = true`.
//
...
const DEFAULT_SESSION_GAP_MS = 60 * 60 * 1000; // 1 hora
 ...
 *   gapMs: hueco temporal (idle) que separa sesiones (default 1 h).
