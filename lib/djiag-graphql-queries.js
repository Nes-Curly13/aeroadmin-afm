// ⚠️  NO FORMATEAR ESTE ARCHIVO — HMAC SENSITIVE  ⚠️
// ─────────────────────────────────────────────────────
// DJI firma cada POST a `kr-ag2-api.dji.com` con un HMAC calculado
// sobre el body EXACTO. Si un formateador (Prettier, editor auto-
// indent, etc.) cambia un solo espacio, tab, o salto de línea dentro
// de las strings `LANDS_QUERY` o `LANDS_CLUSTER_QUERY`, el HMAC deja
// de matchear y DJI responde 401 en TODAS las requests. La query
// sigue siendo "válida" sintácticamente, pero el cliente korean no
// la acepta.
//
// Override de formato si tu editor lo pide:
//   - Prettier: "prettier.disable" en este archivo
//   - ESLint:  rules sobre `no-multi-spaces` o `indent` aplican,
//              pero NO modifiques las queries manualmente.
//
// (XS5 — audit 2026-07-22, docs/DJIAG_AUDIT.md)
//
// Contexto (2026-06-19):
